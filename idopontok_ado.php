...
<body>
      ...
      <div class="navbar-nav w-100 justify-content-between align-items-center">
        ...
        <div class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li><a class="dropdown-item" href="idopontok_ado.php">Időpontjaim</a></li>
  ...
  <div class="time-slots">
    <h3 class="text-center mb-4">Időpontjaim</h3>
    <div class="row">
      <br>
      <br>
      <?php
      $sql = "SELECT * FROM idopontok WHERE ado = '" . $_SESSION["felhasznalo"] . "'";
      $result = $conn->query($sql);

      if ($result->num_rows > 0) {
        echo "<div class='time-buttons d-flex flex-wrap'>";
        while ($row = $result->fetch_assoc()) {
          $sql_foglalo_nev_lekerdezes = "SELECT * FROM foglalt_idopontok WHERE kinel = '" . $_SESSION["felhasznalo"] . "'";
          $result_foglalo_nev_lekerdezes = $conn->query($sql_foglalo_nev_lekerdezes);
        ...
        echo "<p>Nincsenek időpontjaid.</p>";
      }
      ?>
      <br>
      <br>
